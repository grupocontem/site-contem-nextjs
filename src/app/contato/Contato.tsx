                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <form onSubmit={handleSubmitContato}>
                                                        ...
                                                        <div className="d-flex gap-2 align-items-center">
                                                            ...
                                                            {contatoMsg && (
                                                                <div
                                                                    className={`alert alert-${contatoMsg.type} py-2 px-3 mb-0`}
                                                                    role="alert">
                                                                    {contatoMsg.text}
                                                                </div>
                                                            )}
                                        ...
                                        <div className="tab-pane fade show active" role="tabpanel">
                                            <div className="row">
                                                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <h3>OUVIDORIA</h3>
                                                    <p>
                                                        Prezado Cliente, entre em contato com a ouvidoria e informe o
                                                        número do protocolo fornecido. Você receberá
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <form onSubmit={handleSubmitOuvidoria}>
                                                        ...
                                                        <div className="d-flex gap-2 align-items-center">
                                                            <button className="btn btn-primary" type="submit"
                                                                    disabled={loadingOuvidoria}>
                                                                {loadingOuvidoria ? "Enviando..." : "Enviar Ouvidoria"}
                                                            </button>
                                                            {ouvidoriaMsg && (
                                                                <div
                                                                    className={`alert alert-${ouvidoriaMsg.type} py-2 px-3 mb-0`}
                                                                    role="alert">
                                                                    {ouvidoriaMsg.text}
                                                                </div>
                                                            )}
                            ...
                            >
                                <div className="col-md-4 p-4">
                                    ...
                                    <p className="bi bi-geo-alt-fill">
                                        Rua Vigário José Inácio, 368 - sala 603, Centro, Porto Alegre – RS, CEP:
                                        90020-110.
                                    </p>
                                ...
                                <div className="col-md-4 p-4">
                                    ...
                                    <p className="bi bi-geo-alt-fill">
                                        SCS Quadra 6, Bloco A - Lote 141 - Sala 509 - Edifício Presidente, Asa Sul,
                                        Brasília/DF, CEP: 70327-900
                                    </p>
